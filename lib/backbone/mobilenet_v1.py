...
class BasicBlock(nn.Module):
    def __init__(self, inplanes, planes, stride=1, dilation=1, kernel=3, norm='BN', act='ReLU'):
...
class MobileNetV1(nn.Module):
    def __init__(self, widen_factor=1.0, kernel=3, layers=(2, 2, 6, 2), norm='BN', act='ReLU', drop_rate=0.0,
                 num_classes=1000):
        """ Constructor
        Args:
