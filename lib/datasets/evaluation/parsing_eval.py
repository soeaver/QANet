...
from lib.datasets.structures.parsing import get_parsing
from lib.datasets.evaluation.semseg_eval import SemSegEvaluator
...
class ParsingEvaluator:
    ...
    def _compute_class_apr(self, instance_par_gt_dir, instance_par_pred_dir, img_name_list, class_id):
        ...
        for img_name in tqdm(img_name_list, desc='Calculating class: {}..'.format(class_id)):
            instance_img_gt = PILImage.open(os.path.join(instance_par_gt_dir, img_name + '.png'))
            ...
            instance_img_pred = PILImage.open(os.path.join(instance_par_pred_dir, img_name + '.png'))
