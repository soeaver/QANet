...
class PolygonInstance(object):
    ...
    def move(self, gap):
        ...
        return PolygonInstance(moved_polygons, size=(w, h))
    ...
    def set_size(self, size):
        return PolygonInstance(self.polygons, size=size)
...
class PolygonList(object):
    ...
    def move(self, gap):
        ...
        moved_polygons = []
        for polygon in self.polygons:
            moved_polygons.append(polygon.move(gap))

        moved_size = w, h
        return PolygonList(moved_polygons, moved_size)
    ...
    def set_size(self, size):
        setted_size_polygons = []
        self.size = size
        for polygon in self.polygons:
            setted_size_polygons.append(polygon.set_size(size))
        return PolygonList(setted_size_polygons, size)
