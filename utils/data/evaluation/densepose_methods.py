...
class DensePoseMethods:
    def __init__(self):
        if os.path.exists(os.path.join(_DATA_DIR, 'DensePoseData/UV_data/UV_Processed.mat')) \
            and os.path.exists(os.path.join(_DATA_DIR, 'DensePoseData/UV_data/UV_symmetry_transforms.mat')):
            ALP_UV = loadmat(os.path.join(_DATA_DIR, 'DensePoseData/UV_data/UV_Processed.mat')  )
            ...
            self.Index_Symmetry_List = [1, 2, 4, 3, 6, 5, 8, 7, 10, 9, 12, 11, 14, 13, 16, 15, 18, 17, 20, 19, 22, 21,
                                        24, 23]
            UV_symmetry_filename = os.path.join(_DATA_DIR, 'DensePoseData/UV_data/UV_symmetry_transforms.mat')
