...
def flip_uv_featuremap(uvs_hf):
    ...
    os.path.join(UV_DATA_DIR, 'DensePoseData/UV_data/UV_symmetry_transforms.mat')
    UV_symmetry_filename = os.path.join(UV_DATA_DIR, 'DensePoseData/UV_data/UV_symmetry_transforms.mat')
...
class DensePoseMethods:
    def __init__(self):
        assert os.path.exists(os.path.join(UV_DATA_DIR, 'DensePoseData/UV_data/UV_Processed.mat'))
        assert os.path.exists(os.path.join(UV_DATA_DIR, 'DensePoseData/UV_data/UV_symmetry_transforms.mat'))

        ALP_UV = loadmat(os.path.join(UV_DATA_DIR, 'DensePoseData/UV_data/UV_Processed.mat'))
