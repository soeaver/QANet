...
class gce_head(nn.Module):
    def __init__(self, dim_in):
        ...
        use_bn = cfg.PARSING.GCE_HEAD.USE_BN
        use_gn = cfg.PARSING.GCE_HEAD.USE_GN
        conv_dim = cfg.PARSING.GCE_HEAD.CONV_DIM
        asppv3_dim = cfg.PARSING.GCE_HEAD.ASPPV3_DIM
        num_convs_before_asppv3 = cfg.PARSING.GCE_HEAD.NUM_CONVS_BEFORE_ASPPV3
        asppv3_dilation = cfg.PARSING.GCE_HEAD.ASPPV3_DILATION
        num_convs_after_asppv3 = cfg.PARSING.GCE_HEAD.NUM_CONVS_AFTER_ASPPV3
        ...
        if use_nl:
            feat_list.append(
                NonLocal2d(conv_dim, int(conv_dim * cfg.PARSING.GCE_HEAD.NL_RATIO), conv_dim, use_gn=True)
            )
